...
const checkChange = function() {
    ...
    header.style.backgroundColor = checkHeader.checked ? "transparent" : window.scrollY > 100 ? "#252b46e6" : "";
};
// Scroll to view
...
const stickyNav = function(entries) {
    ...
    header.style.backgroundColor = window.innerWidth <= 640 ? entry.isIntersecting ? "transparent" : "#252b46e6" : "";
};
...
const calculateRootMargin = ()=>{
    ...
    let rootMargin = "";
    // Compare breakpoints
    if (screenWidth > 900) // For larger screens
    rootMargin = `-${sectionHeight + 50}px 0px 0px 0px`;
    else if (screenWidth > 640) // For medium screens
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["8NmFf","2OD7o"], "2OD7o", "parcelRequiree2cb")
